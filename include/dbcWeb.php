...
// define ("DB_USER", "logistk7_user"); // set database user
// define ("DB_PASS","AcclerateMe3@"); // set database password
// define ("DB_NAME","logistk7_db"); // set database name
// define ("WEB_PATH","http://logisticsgms.com/"); //Website URL

define ("DB_HOST", "localhost"); // set database host
define ("DB_USER", "root"); // set database user
define ("DB_PASS",""); // set database password
define ("DB_NAME","logistk7_db"); // set database name
define ("WEB_PATH","http://localhost/mikong_nitish/"); //Website URL
...
//$webUrl = "http://www.newslivetv.org/beta_version/";
//$webUrl = "http://logisticsgms.com/";
...
/* We also do authentication check of the ckey stored in cookie matches that stored in database during login*/
	...
	header("Location: ".WEB_PATH."cms/index.php");
	exit();
	}
}
}
