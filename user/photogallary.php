                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" role="form">    
                                <h3 class="heading_a"><span class="heading_text">Awards</span></h3>
                                <div class="form-group">
                                    <div class="col-sm-10">
                                      <?Php $getPics = getPics($dataList[0][0],"awards");
				                                ...
				                                for($i=0;$i<count($getPics);$i++)
				                                {
				                                 ?>  
			                                   <div class="col-md-2">
			                                   <a class="example-image-link" href="<?php echo $webUrl;?>register/images/awards/<?php echo $getPics[$i][2];?>" data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
			                                   	<img src="<?php echo $webUrl;?>register/images/awards/<?php echo $getPics[$i][2];?>" style="display: block; width: 100%; height: auto; max-width: 100%; max-height: 100%;">
			                                   </a>	
			                                   	<br/>
                                    ...
                                    <h3 class="heading_a"><span class="heading_text">Certifications</span></h3>
                                <div class="form-group">
                                    <div class="col-sm-10">
                                      <?Php $getPics = getPics($dataList[0][0],"certificate");
			                                   ...
			                                   <a class="example-image-link" href="<?php echo $webUrl;?>register/images/certificate/<?php echo $getPics[$i][2];?>" data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
			                                   	<img src="<?php echo $webUrl;?>register/images/certificate/<?php echo $getPics[$i][2];?>" style="display: block; width: 100%; height: auto; max-width: 100%; max-height: 100%;">
			                                   </a>	
			                                   	<br/>
			                                   <label>	<?php echo $getPics[$i][3];?></label>
                                     ...
                                     <h3 class="heading_a"><span class="heading_text">Marketing Materials</span></h3>
                                	<div class="form-group">
                                    <div class="col-sm-10">
                                      <?Php $getPics = getPics($dataList[0][0],"marketing");
			                                   ...
			                                   <a class="example-image-link" href="<?php echo $webUrl;?>register/images/marketing/<?php echo $getPics[$i][2];?>" data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
			                                   	<img src="<?php echo $webUrl;?>register/images/marketing/<?php echo $getPics[$i][2];?>" style="display: block; width: 100%; height: auto; max-width: 100%; max-height: 100%;">
			                                   </a>	
			                                   	<br/>
			                                   <label>	<?php echo $getPics[$i][3];?></label>
                                    ...
                                    <h3 class="heading_a"><span class="heading_text">Video (Youtube)</span></h3>
                                	<div class="form-group">
                                    <div class="col-sm-10">
