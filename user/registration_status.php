                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" role="form">    
                                <h3 class="heading_a"><span class="heading_text">Registration Status</span></h3>
                                <div class="form-group">
                                    <label for="profile_skype" class="col-sm-2 control-label">Year of Registration</label>
                                    <div class="col-sm-10">
                                       <label  class="form-control"><?php echo $dataList[0][42];?></label> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="profile_fb" class="col-sm-2 control-label">Registration Authority</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label for="profile_email" class="col-sm-2 control-label">Company’s Registration No.</label>
                                    <div class="col-sm-10">
                                         <label  class="form-control">
                                ...
                                <div class="form-group">
                                    <label for="profile_email" class="col-sm-2 control-label">Company Proprietary Status </label>
                                    <div class="col-sm-10">
                                         <label  class="form-control">
                                ...
                                <h3 class="heading_a"><span class="heading_text">Scanned registration document</span></h3>
                                <div class="form-group">
                                
                                <?Php 
								$getPics = getPics($dataList[0][0],"reg_no");
				                                if(count($getPics)>0)
				                                {
				                                for($i=0;$i<count($getPics);$i++)
				                                {
				                                 ?>  
			                                   <div class="col-md-2">
			                                   <a class="example-image-link" href="<?php echo $webUrl;?>register/images/registration_img/<?php echo $getPics[$i][2];?>" data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
			                                   	<img src="<?php echo $webUrl;?>register/images/registration_img/<?php echo $getPics[$i][2];?>" style="display: block; width: 100%; height: auto; max-width: 100%; max-height: 100%;">
			                                   </a>	
			                                   	<br/>
