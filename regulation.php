...
<section class="inner-banner">
	<div class="thm-container">
		<h2>Regulation & Agreements</h2>
		<ul class="breadcumb">
			<li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
			<li><span>Regulation & Agreements</span></li>
		</ul>
	</div>
</section>
	...
	<div class="thm-container">
		<div class="row">
			...
			<div class="col-md-8 pull-right">
				<div class="sec-title">
					<h2><span>Regulation & Agreements</span></h2>
					<p>With updated and comprehensive regulation and agreements on transport and logistics at national (CLMVT Countries), regional (GMS and ASEAN) and international level.
