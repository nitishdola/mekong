			...
			<div class="nav-holder pull-left">
				...
				<div class="nav-footer">
                    ...
                    <li class="has-submenu">
							<a href="javascript:void(0)">Welcome "Administrator" (<?php $country = getCountry($_SESSION['countryid']); echo ucfirst($country[0][2]);?>)</a>
							<!--<ul class="submenu">
						...
						<li><a href="<?php echo $pageUrl;?>admin/logout.php">Logout</a></li>
					</ul>
				</div>
			</div>
