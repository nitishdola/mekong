                ...
                <div class="info-box">
                    ...
                    <div class="text-box">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><img src="images/facebook.png" width="38" height="38" />
                                </td>
                                <td><img src="images/twitter.png" width="38" height="38" />
                                </td>
                                <td><img src="images/gplus.png" width="38" height="38" />
                                </td>
                                <td><img src="images/skyp.png" width="38" height="38" />
                                </td>
                                <td><img src="images/link-in.png" width="38" height="38" />
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <form action="#" class="search-box-holder">
                        <div class="search-box">
                            <div class="form">
                                ...
                                <button type="submit"><span>GO</span>
                                </button>
                            </div>
                        </div>
                    </form>
            ...
            <div class="clearfix">
                ...
                <li><a href="pricing.html">Our Pricing</a></li>
                            ...
                            <li class="has-submenu">
                                <a href="#">About us</a>
                                <ul class="submenu">
                                    <li><a href="gms-logistics-database.php">GMS Logistics Database</a>
                                    </li>
                                    <li><a href="logistics-project.php">Logistics Dev. Project</a>
                                    </li>
                                    <li><a href="project-partners.php">Project Partners</a>
                                    </li>
                                    <li><a href="related-websites.php">Related Websites</a>
                                    </li>
                                    <li><a href="mekong-institute.php">Mekong Institute</a>
                                    </li>
                                </ul>
                            </li>

                            <li class="has-submenu"><a href="logistics-data.php">Company Database</a>
                            </li>
                            <li class="has-submenu"><a href="forum.php">Forum</a>
                            </li>
                            <li class="has-submenu"><a href="regulation.php">Regulation</a>
                            </li>

                            <li><a href="#">Events</a>
                                <ul class="submenu">
                                    <li style="background-color:#CDCDCE"><a href="#">Cambodia</a>
                                    </li>
                                    <li style="background-color:#CDCDCE"><a href="#">Lao PDR</a>
                                    </li>
                                    <li style="background-color:#CDCDCE"><a href="#">Myanmar</a>
                                    </li>
                                    <li style="background-color:#CDCDCE"><a href="#">Vietnam</a>
                                    </li>
                                    <li style="background-color:#CDCDCE"><a href="#">Thailand</a>
                                    </li>
                                    <li style="background-color:#CDCDCE"><a href="#">Others</a>
                                    </li>
                                </ul>
                            </li>

                            <li><a href="http://logisticsgms.com/signup.php">Login</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="tabs widget">
                        <ul class="nav nav-tabs widget">
                            <li class="active"> <a data-toggle="tab" href="#profile-tab"> Company Profile <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a>
                            </li>
                            <li> <a data-toggle="tab" href="#services"> Services <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a>
                            </li>
                            <li> <a data-toggle="tab" href="#business_interaction"> Business interaction <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a>
                            </li>
                            <li> <a data-toggle="tab" href="#news_events"> News &amp; Events <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a>
                            </li>
                        </ul>
                                                        ...
                                                        <div class="row" style="padding: 10px;">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div class="row mgbt-xs-0">
                                                                    ...
                                                                    <div class="col-xs-6 controls">
                                                                        ...
                                                                        <?php echo htmlspecialchars_decode(html_entity_decode($dataList[0][17]));?>
                                                                    </div>
                                                                    <!-- col-sm-10 -->
                                                                </div>
                                                                ...
                                                                <div class="row mgbt-xs-0">
                                                                    ...
                                                                    <div class="col-xs-6 controls">
                                                                        <?php echo htmlspecialchars_decode(html_entity_decode($dataList[0][59]));?>
                                                                    </div>
                                                                    <!-- col-sm-10 -->
                                                                </div>
                                                                ...
                                                                <div class="row mgbt-xs-0">
                                                                    ...
                                                                    <div class="col-xs-6 controls">
                                                                        <?php echo htmlspecialchars_decode(html_entity_decode($dataList[0][60]));?>
                                                                    </div>
                                                                    <!-- col-sm-10 -->
                                                                </div>
                                                                ...
                                                                <div class="row mgbt-xs-0">
                                                                    ...
                                                                    <div class="col-xs-6 controls">
                                                                        <?php echo htmlspecialchars_decode(html_entity_decode($dataList[0][16]));?>
                                                                    </div>
                                                                    <!-- col-sm-10 -->
                                                                </div>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="row mgbt-xs-0">
                                                                    ...
                                                                    <div class="col-xs-6 controls">
                                                                        <a href="<?php if($dataList[0][22]!=" ") echo htmlspecialchars_decode(html_entity_decode($dataList[0][22]));?>" target="_blank">
                                                                            <?php if($dataList[0][22]!="" ) echo htmlspecialchars_decode(html_entity_decode($dataList[0][22]));?>h</a>
                                                                    </div>
                                                                    <!-- col-sm-10 -->
                                                                </div>
                                                            </div>
                                ...
                                <div class="pd-10">
                                    <div class="row">
                                        <div class="col-sm-6 mgbt-xs-20" style="margin-top:6px;">
                                            <h4 class="mgbt-xs-15 font-semibold" style="background-color: #2E6FAB; border-radius: 5px; color: #fff; padding: 10px;">
              <img src="images/icon4.jpg"> BUSINESS AREAS
            </h4>
                                            <div class="content-list content-menu">
                                                <div class="row" style="padding: 10px;">
                                                    <div>
                                            ...
                                            <div class="content-list content-menu">
                                                <div class="row" style="padding: 10px;">
                                                    <div>
                                                        ...
                                                        <div class="col-xs-6 controls">
                                                            <?php if($dataList[0][37]!="" ) echo htmlspecialchars_decode(html_entity_decode($dataList[0][37])); else echo "Not available";?>
                                                        </div>
                                                        <!-- col-sm-10 -->
                                                    </div>
                                                    <div style="clear:both"></div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="col-xs-6 controls">
                                                            <?php if($dataList[0][39]!="" ) echo htmlspecialchars_decode(html_entity_decode($dataList[0][39])); else echo "Not available";?> </div>
                                                        <!-- col-sm-10 -->
                                                    </div>
                                                    <div style="clear:both"></div>
                                                    <?php endif; ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-6">
                        ...
                        <p>Contact us now to get quote for all your global
                            <br>shipping and cargo need.</p>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="thm-container">
            <div class="row">
                <div class="col-md-31 col-sm-6 footer-widget">
                    <div class="pl-30">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="logistics-data.php">Company Database</a>
                            </li>
                            <li><a href="forum.php">Forum</a>
                            </li>
                            <li><a href="regulation.php">Regulation</a>
                            </li>
                            <li><a href="#">Events</a>
                            </li>
                            <li><a href="signup.php">Login</a>
                            </li>
                ...
                <div class="col-md-31 col-sm-6 footer-widget">
                    <div class="pl-30">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="related-websites.php">Related Website</a>
                            </li>
                            <li><a href="mekong-institute.php">Mekong Institute</a>
                            </li>
                ...
                <div class="col-md-2 col-sm-6 footer-widget">
                    ...
                    <P><img src="images/01.png" width="89" height="87">
                    </P>

                    <div class="title">
                        <h3><span>FUNDED BY </span></h3>
                    </div>
                    <P><img src="images/02.png" width="89" height="100">
                    </P>
                </div>
                <div class="col-md-4 col-sm-6 footer-widget">
                    ...
                    <ul class="contact-infos">
                        <li>
                            ...
                            <div class="text-box">
                                <p><b>Mekong Institute</b>
                                    <br> 123 Khon Kaen University Mittraphap Rd., Muang District, Khon Kaen 40002, THAILAND</p>
                            </div>
                        </li>
                        <li>
                            <div class="icon-box">
    ...
    <section class="bottom-bar">
        <div class="thm-container clearfix">
            ...
            <div class="pull-right">
                <p>Powered by: <a href="http://webcomindia.biz/" target="_blank">Web.Com (India) Pvt. Ltd.</a>
                </p>
            </div>
        </div>
    </section>
