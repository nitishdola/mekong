...
<section class="sec-padding page-title">
	<div class="thm-container">
	  <div class="sec-title">
	    ...
	    <br>
	    With over 3,000 companies profiles in Logistics
sector based in five GMS countries, namely
Cambodia, Laos, Myanmar, Vietnam and Thailand , users are able to:
          <br>
         Access companies directory<br>
         Identify the right service providers by sorting
on location, services catalog, review
ranking and any keyword<br>
         Registered members can customize company
profiles, list products and service,
review and comment to other company
        <br>
         Participate in online business matching and
forum
	</div>
	</div>
</section>
