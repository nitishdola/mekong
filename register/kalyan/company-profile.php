...
$dataList = getUserdata(trim(htmlentities($_GET['q'])),3);
...
<head>
	...
	<!-- styles -->
	<!-- helpers -->
	<link rel="stylesheet" href="<?php echo $webUrl;?>plugins/bootstrap/css/bootstrap.min.css">
	<!-- fontawesome css -->
	<link rel="stylesheet" href="<?php echo $webUrl;?>plugins/font-awesome/css/font-awesome.min.css">
	<!-- strock gap icons -->
	<link rel="stylesheet" href="<?php echo $webUrl;?>plugins/Stroke-Gap-Icons-Webfont/style.css">
	<!-- revolution slider css -->
	<link rel="stylesheet" href="<?php echo $webUrl;?>plugins/revolution/css/settings.css">
	<link rel="stylesheet" href="<?php echo $webUrl;?>plugins/revolution/css/layers.css">
	<link rel="stylesheet" href="<?php echo $webUrl;?>plugins/revolution/css/navigation.css">
	<!-- flaticon css -->
	<link rel="stylesheet" href="<?php echo $webUrl;?>plugins/flaticon/flaticon.css">
	<!-- jQuery ui css -->
	<link href="<?php echo $webUrl;?>plugins/jquery-ui-1.11.4/jquery-ui.css" rel="stylesheet">
	<!-- owl carousel css -->
	<link rel="stylesheet" href="<?php echo $webUrl;?>plugins/owl.carousel-2/assets/owl.carousel.css">
	<link rel="stylesheet" href="<?php echo $webUrl;?>plugins/owl.carousel-2/assets/owl.theme.default.min.css">
	<!-- animate css -->
	<link rel="stylesheet" href="<?php echo $webUrl;?>plugins/animate.min.css">
	<!-- fancybox -->
	<link rel="stylesheet" href="<?php echo $webUrl;?>plugins/fancyapps-fancyBox/source/jquery.fancybox.css">
...
<section class="inner-banner">
	<div class="thm-container">
		<h2>Company Profile (<?php $r=getCountry($dataList[0][15]); echo strtoupper($r[0][2]);?>)</h2>
...
<section class="sec-padding page-title">
	<div class="thm-container">
		<div class="sec-title">
			<h2><span><?php echo strtoupper($dataList[0][2]);?> Profile</span></h2>
...
<!-- jQuery js -->
<script src="<?php echo $webUrl;?>plugins/jquery/jquery-1.11.3.min.js"></script>
<!-- bootstrap js -->
<script src="<?php echo $webUrl;?>plugins/bootstrap/js/bootstrap.min.js"></script>
<!-- jQuery ui js -->
<script src="<?php echo $webUrl;?>plugins/jquery-ui-1.11.4/jquery-ui.js"></script>
<!-- owl carousel js -->
<script src="<?php echo $webUrl;?>plugins/owl.carousel-2/owl.carousel.min.js"></script>
<!-- jQuery appear -->
<script src="<?php echo $webUrl;?>plugins/jquery-appear/jquery.appear.js"></script>
<!-- jQuery countTo -->
<script src="<?php echo $webUrl;?>plugins/jquery-countTo/jquery.countTo.js"></script>
<!-- jQuery validation -->
<script src="<?php echo $webUrl;?>plugins/jquery-validation/dist/jquery.validate.min.js"></script>
<!-- gmap.js helper -->
<script src="http://maps.google.com/maps/api/js"></script>
<!-- gmap.js -->
<script src="<?php echo $webUrl;?>plugins/gmap.js"></script>
<!-- mixit up -->
<script src="<?php echo $webUrl;?>plugins/jquery.mixitup.min.js"></script>

<!-- revolution slider js -->
<script src="<?php echo $webUrl;?>plugins/revolution/js/jquery.themepunch.tools.min.js"></script>
<script src="<?php echo $webUrl;?>plugins/revolution/js/jquery.themepunch.revolution.min.js"></script>
<script src="<?php echo $webUrl;?>plugins/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script src="<?php echo $webUrl;?>plugins/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script src="<?php echo $webUrl;?>plugins/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script src="<?php echo $webUrl;?>plugins/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="<?php echo $webUrl;?>plugins/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script src="<?php echo $webUrl;?>plugins/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script src="<?php echo $webUrl;?>plugins/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script src="<?php echo $webUrl;?>plugins/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script src="<?php echo $webUrl;?>plugins/revolution/js/extensions/revolution.extension.video.min.js"></script>

<!-- fancy box -->
<script src="<?php echo $webUrl;?>plugins/fancyapps-fancyBox/source/jquery.fancybox.pack.js"></script>
<!-- type script -->
<script src="<?php echo $webUrl;?>plugins/typed.js-master/dist/typed.min.js"></script>

<!-- theme custom js  -->
<script src="<?php echo $webUrl;?>js/main.js"></script>
