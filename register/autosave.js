...
function saveFormData( vr = 0) {
    if (vr > 0)
    {
        ...
        //prepare the data
         txtName =  txtSlogan =  FCKeditor =  rd1 =  txtLegalTitle = '';
         txtLegalSurname =  txtLegalName =  txtFocalPersonTitle = '';
        ...
        if($('#txtLegalTitle').val().trim() != '') {
          txtLegalTitle = $('#txtLegalTitle').val().trim()
        }
        if($('#txtLegalSurname').val().trim() != '') {
          txtLegalSurname = $('#txtLegalSurname').val().trim()
        }
        if($('#txtLegalName').val().trim() != '') {
          txtLegalName = $('#txtLegalName').val().trim()
        }
 ...
 $.blockUI({ css: { 
        ...
        $.post('save_user_data_ajax.php',{
          ...
          FCKeditor 	: FCKeditor,
          rd1 : rd1,
          txtLegalTitle   : txtLegalTitle,
          txtLegalSurname   : txtLegalSurname,
