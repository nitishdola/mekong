...
$valid_formats = array("jpg", "png", "gif", "bmp","jpeg","pdf","zip","rar","doc","docx");
if(!isset($_POST['submit1'])=="Confirm") 
{
	
    $uploaddir = "images/marketing/"; //a directory inside
        ...
        //get the extension of the file in a lower case format
         ...
         if(in_array($ext,$valid_formats))
         {
		   ...
		   //echo "<div style='clear:both'></div>";
		    echo "<div style='margin-left:20px;'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<font color='#000' face='arial' size='2'>Caption</font> <input type='text' name='txtCaption$image_name' id='txtCaption$image_name'>
		   ...
		   if($cn == false)
			connect3db();
		   $sq = "INSERT INTO tbl_img(id,data_id,file_name,status,category) VALUES($sl,$data_id,'$image_name','0','marketing')";
	       mysql_query($sq);
	       }
	       else
	       {
