...
<div class="col-md-12">
            <div class="row">
            	<?php
				$sql = "select * from tbl_img where status='1' and data_id='".$data_id."' and category='marketing'";
				if($cn == false)
				connect3db();
				$res = mysql_query($sql);
               ...
               <a href="images/marketing/<?php echo $row['file_name'];?>" class="highslide"  onclick="return hs.expand(this)"> <img src="images/marketing/<?php echo $row['file_name'];?>" style="max-width:100%; height:100%; border:2px solid #000;" /></a><br />
...
<form id="imageform" class="form-horizontal" action="marketingImgUplaod.php" method="post" enctype="multipart/form-data">
<br />
<div id='imageloadbutton'><span class="style1">Click on the browse button to upload 
Marketing materials</span><input type="file" name="photos[]" id="photoimg" multiple="true" /><span id="c"></span>
</div>
