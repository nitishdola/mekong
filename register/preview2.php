						...
						<div class="formtitle">Business Areas</div>
                            ...
                            <div class="form-group">
                               ...
                               <div class="form-group">
								...
								<div class="form-group">
						    <label class="control-label col-md-3"> <strong>Photos of fixed assets</strong>
                           </label>
                                    <label class="control-label col-md-7">
                                  		<div class="form-group"> 
                               ...
                               <div class="formtitle">Registration Status</div>
                                 ...
                                 <div class="form-group">
                                  	<label class="control-label col-md-5"><strong>Registration No.</strong>   <span class="redmi1">*</span></label>
                                   <label class="control-label col-md-6">
                               	 ...
                               	 <div class="form-group">
						    <label class="control-label col-md-5"> <strong>Scanned company registration</strong>
                           </label>
                                    <label class="control-label col-md-6">
                                  		<div class="form-group"> 
