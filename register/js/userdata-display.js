$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(p < max_fields0){ //max input box allowed
            ...
            $(wrapper).append('<div><input type="text" name="txtOffcPhone[]" id="txtOffcPhone[]" value='+idd+' class="input" style="width:80%"/><a href="javascript:void(0)" class="remove_field" margin-left:20px"><i class="fa fa-minus-square fa-2x" aria-hidden="true"></i></a></div>'); //add input box
        }
    });
	...
	$("#add_field_button_selBranch").click(function(e){ //on add input button click
        ...
        if(d < max_fields10){ //max input box allowed
           ...
           social_field1 = '';
		    ...
		    social_field1 += '<select class="form-control" name="selEcommerce[]" id="selEcommerce">';
		    ...
		    social_field1 += '<input type="text" class="form-control" name="txtEcomUrl[]" id="txtEcomUrl" required placeholder="">';
