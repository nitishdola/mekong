			...
			<div class="nav-holder pull-left">
				...
				<div class="nav-footer">
                    ...
                    <li class="has-submenu">
							<a href="javascript:void(0)">Welcome "<?php echo strtoupper($_SESSION['f_name']).' '.strtoupper($_SESSION['l_name']);?>" </a>
							<!--<ul class="submenu">
						...
						<li><a href="<?php echo $pageUrl;?>register/logout.php">Logout</a></li>
					</ul>
				</div>
			</div>
