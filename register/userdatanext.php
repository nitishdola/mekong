...
if(isset($_POST['submit'])=="Submit")
{
		...
		if(!empty($_POST['selLocation']))
		{
			...
			{
				$selLocation1 .= $selLocation.",";
			}
			$selLocationM = left($selLocation1,strlen($selLocation1)-1);
		}
...
<script src="http://code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
	...
	<script type="text/javascript">
		function authacc(){
			var a = document.getElementById("chkAccept").checked;
			if(a==false)
			{
				alert("please check the authorization box");
				return false;
			}
			return true;
		}
...
	Please select ‘others’ if your services are out of the given list and please fill in the details in the box. 
                              ...
                              <input type="text" name="txtBusinessOther"  id="txtBusinessOther" class="form-control" style="display: none">
                              <script type="text/javascript">
								(function($) {
									$("#chkBusiness1").click(function() {
										if($("#txtBusinessOther").is(':hidden'))
										{
											$("#txtBusinessOther").slideDown("normal");
										}
										else
										{
											$("#txtBusinessOther").slideUp("normal");
										}
									});
...
Click “+” to add more industry focus and products </span></a></label>
                               ...
                               <label class="control-label col-md-12">
								...
								(function($) {
                                 ...
                                 <div class="form-group">
                                  	<label class="control-label col-md-3"><strong>Business Geographic Coverage</strong> <span class="redmi1">*</span> <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Please select the regions where your company operates business and provides services <br>
                                    &#8226; Click + to add more regions.<br>
									 &#8226; Please provide specific countries in the box
  </span></a></label>
                                 ...
                                 <div class="form-group">
                                  	...
                                  	Please provide the number of your assets and upload photos</span></a></label>
                               ...
                               <div class="formtitle">Registration Status</div>
                                 ...
                                 <div class="form-group">
                                  	<label class="control-label col-md-3"><strong>Registration No.</strong>   <span class="redmi">*</span> <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Please provide your company’s registration number. 
...
Suggest but not mandatory to upload scanned registration file to add credibility to your company
                                   ...
                                   <div class="col-md-7">
                                    ...
                                    <label class="control-label col-md-12">
                                    <a href="registration_img.php"   onclick="return hs.htmlExpand(this, { objectType: 'iframe',height: 450,width: 700 } )">Click to upload the scanned registration document(optional)</a>
                                    </label>
                                   </div>
                                 </div>
...
(function($) {
 ...
 <div class="form-group">
                                  	<label class="control-label col-md-3"> <strong>Location of Your Membership Organization / Network</strong> <span class="redmi1"></span>   <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Please select the countries where your membership organizations/networks based in. Click + to add more
  </span></a></label>
...
<br>
    ...
    <div class="booking-complete" align="center">
							<button class="thm-btn" type="button" name="btnSubmit1" id="btnSubmit1" data-toggle="modal"  style="float:left; margin-left:10PX;"  title="Click this button to preview and edit the form if required">Preview</button>
                                ...
                                <button class="thm-btn" onClick="return authacc();xx()" name="submit" type="submit" style="float:left; margin-left:10PX;" value="Submit">Submit</button>
							</div>
				<div class="clear"></div>                           
