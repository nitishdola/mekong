				 ...
				 <?php } ?>
				 		<div style="margin-top:4%"></div>
                       	<div class="form-group">
						    ...
						    <div class="col-md-7">
						    	<input type="text" name="txtName" id="txtName"required onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" class="form-control" >
						    </div>
						</div>

						<div class="form-group">
						    <label class="control-label col-md-3"> Logo of Company <span class="redmi">*</span> <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Logo Format: JPG / PNG / GIF; <br>Size: < 1MB <br> </span></a></label>
						    <div class="col-md-7">
						...
						<div class="form-group">
						    ...
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtSlogan"  id="txtSlogan" onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')">
						    </div>
						</div>

						<div class="form-group">
                        	<label class="control-label col-md-4"> Company Introduction <span class="redmi">*</span><a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Please input company introduction here in the format of text, photo and video    </span></a></label>
                        	<div class="col-md-12">
                        		 <textarea name="FCKeditor" id="FCKeditor"></textarea>
							</div>
                        </div>
                	</div>
                    <div class="col-md-6"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                            	<label class="radio-inline" for="radios-0">
                            		<input name="rd1" class="of_rad1" id="rd1" type="radio" value=" Headquarter" checked="checked"  required /> Headquarter
                            	</label>
                            	<label class="radio-inline" for="radios-0">
									<input name="rd1" class="of_rad1" id="rd1" type="radio" value="Branch office" required /> Branch office
								</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
						    ...
						    <div class="col-md-2">
						    	<select name="txtLegalTitle" class="form-control" id="txtLegalTitle" required>
                                   <option value="">--</option>
						...
						<div class="form-group">
						    ...
						    <div class="col-md-7">
						    	<input type="text"  name="txtLegalSurname" id="txtLegalSurname" required  value="" class="form-control" placeholder="Surname"  onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')"/>
						    </div>
						</div>
						<div class="form-group">
						    <label class="control-label col-md-3">&nbsp;</label>
						    <div class="col-md-7">
						    	<input type="text"  name="txtLegalName" id="txtLegalName" required  value="" class="form-control" placeholder="Name"  onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')"/>
						    </div>
						</div>
						...
						<div class="form-group">
						    <label class="control-label col-md-3">&nbsp;</label>
						    <div class="col-md-7">
						    	<input type="text"  name="txtFocalPersonSurname" id="txtFocalPersonSurname" required  value="" class="form-control" placeholder="Surname"  onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')"/>
						    </div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-md-3">&nbsp;</label>
						    <div class="col-md-7">
						    	<input type="text"  name="txtFocalPersonName" id="txtFocalPersonName" required  value="" class="form-control" placeholder="Name"  onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" />
						    </div>
						</div>
						...
						<div class="form-group">
						    ...
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtPostion"  id="txtPostion" onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="The focal person’s position">
						    </div>
						</div>
                        
                        <div class="form-group">
						    <label class="control-label col-md-3"> Department <span class="redmi">*</span> <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />The focal person’s position    </span></a></label>
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtDepartment"  id="txtDepartment" onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="The Department Name">
						    </div>
						</div>
						...
						<div class="form-group">
						    ...
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtCompanyAddrStreet" id="txtCompanyAddrStreet"  onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="Street, District">
						    </div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">&nbsp;</label>
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtCompanyAddrCity" id="txtCompanyAddrCity"  onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="City">
						 	</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">&nbsp;</label>
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtPostCode" id="txtPostCode"  onKeyUp="this.value=this.value.replace(/[^0-9+-/?+ ]+/g,'')" placeholder="Postal Code">
						    </div>
						</div>
						...
						<div class="form-group">
						    <label class="control-label col-md-3"> Mobile Phone <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Not compulsory, but suggest to provide and keep updating for better communication</span></a></label>
						    <div class="col-md-6" id="input_fields_wrap_mobile">
						    	<input type="text" class="form-control" name="txtMobilePhone[]" id="txtMobilePhone" onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="Mobile no">
						    </div>
						    <div class="col-md-1">
						...
						<div class="form-group">
						    <label class="control-label col-md-3"> E-mail  <span class="redmi">*</span><a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Please provide the permanent email and / or working email address  of the company used for public relations or marketing    </span></a></label>
						    <div class="col-md-7">
						...
						<div class="form-group">
						    <label class="control-label col-md-3"> Company Website  <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Not compulsory, but suggest to provide if you have.     </span></a></label>
						    <div class="col-md-7">
						    	<input type="url" class="form-control" name="txtCompanyWebsite" id="txtCompanyWebsite" placeholder="Company Website(if any)">
						    </div>
						</div>
						<!--begin social field-->
						<div id="social_plugings">
							<div class="form-group">
							    <label class="control-label col-md-3"> Social/ecommerce Platform <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Select your company’s social network first and then provide the URL or ID in the box beside      </span></a></label>
							    <div class="col-md-2"  id="input_fields_wrap_sel">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-6">
                            		<input type="radio" name="rd2" id="geo_cord" class="x" value="Coordinates"> Geographic coordinates
                                    ...
                                    <div id="x1" style="display:none;" class="form-group">
                                        <div class="col-md-12">
                                            Latitude <input type="text"  name="txtLatitude" id="txtLatitude" class="form-control"   value="" class="input" />
                                        </div>  
           
                                        <div class="col-md-12">       
                                        Longitude <input type="text"  name="txtLongitude" id="txtLongitude"   value="" class="form-control" />
                                        </div>
                                    </div>
                                    
                             </div>
                              <div class="col-md-6">
									<input type="radio" name="rd2" id="geo_url" class="y" value="Geographic URL"> Geographic URL  
									<a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" /><strong>1.</strong>Enter the name and area of the organisation in search input box of google map.<br>
                     ...
                     <div class="form-group">
						...
						<div class="form-group">
						    ...
						    <div class="col-md-6" id="input_fields_wrap_mobileBranch">
						    	<input type="text" class="form-control" name="txtBranchMobilePhone[]" id="txtBranchMobilePhone" onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="The focal person’s mobile position">
						    </div>
						    <div class="col-md-1">
						...
						<div class="form-group">
						    <label class="control-label col-md-3"> Company Website  <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Not compulsory, but suggest to provide if you have.     </span></a></label>
						    <div class="col-md-7">
						    	<input type="url" class="form-control" name="txtBranchCompanyWebsite" id="txtBranchCompanyWebsite" placeholder="Company Website(if any)">
						    </div>
						</div>
						<!--begin social field-->
