                ...
                <div class="col-md-6">
				 ...
				 <?php } ?>
						...
						<div class="form-group">
						    ...
						    <div class="col-md-7">
						    	<input type="file" class="input" name="logo" <?php if($dataList[0][3]=="") echo "required" ;?>  id="logo" onchange="readURL(this);" accept="image/gif, image/jpeg, image/png">
...
•	Highlights: e.g. list down your unique services, cooperation partners, and outstanding achievements etc.
                    ...
                    <div class="col-md-6"> 
						...
						<div class="form-group">
						    <label class="control-label col-md-3"> <strong>Company Address</strong>  <span class="redmi">*</span> </label>
						    <div class="col-md-7">
						...
						<?php 
							...
							if($i==0){?>
                            <div class="form-group"> 
                            <label class="control-label col-md-3"><strong> fax </strong><span class="redmi">*</span> <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Click “+” to add more     </span></a></label>  
						...
						<?php 
							...
							if($i==0){?>
                            <div class="form-group"> 
                            <label class="control-label col-md-3"> <strong>Mobile Phone </strong><span class="redmi">*</span> <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Click “+” to add more     </span></a></label>  
...
Use comma ‘,’ to add more email address    </span></a></label>
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtEmail" id="txtEmail" required placeholder="Valid Email ID" value="<?php echo $dataList[0][21];?>">
						    </div>
						</div>
						...
						<div class="form-group">
						    ...
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtCompanyWebsite" id="txtCompanyWebsite" placeholder="Company Website(if any)" required value="<?php echo $dataList[0][22];?>">
						    </div>
						</div>
						<!--begin social field-->
                        <?php
...
Select your company’s social network / e-commerce platform first and then provide URL or ID in the box beside
							    ...
							    <div class="col-md-2">
							    	<select class="form-control" name="selEcommerce[]" id="selEcommerce">
										...
										<option value="Amazon"  <?php if($ecom[$i]=="LinkedIn") echo "selected";?>>Amazon </option>
										<option value="Alibaba"  <?php if($ecom[$i]=="LinkedIn") echo "selected";?>>Alibaba </option>
										<option value="eBay"  <?php if($ecom[$i]=="LinkedIn") echo "selected";?>>eBay</option>
										<option value="Other"  <?php if($ecom[$i]=="LinkedIn") echo "selected";?>>Other</option>  
	                                </select>
							    </div>
                      ...
                      <?php } } ?>
						...
						<div class="form-group">
                            ...
                            <div class="col-md-4">
                            		<label><input type="radio" name="rd2" id="geo_cord" class="x" value="Coordinates" <?php if($dataList[0][25]!="") echo "checked";?>> Geo. coordinates</label>
                                    ...
                                    <div id="x1" <?php if($dataList[0][25]==""){?>style="display:none"<?php } ?> class="form-group">
                                        <div class="col-md-12">
                                            <label>Latitude <input type="text"  name="txtLatitude" id="txtLatitude" class="form-control"  class="input" value="<?php echo $dataList[0][25];?>"/></label>
                                        </div>  
           
                                        <div class="col-md-12">       
                                        <label>Longitude <input type="text"  name="txtLongitude" id="txtLongitude"  class="form-control" value="<?php echo $dataList[0][26];?>" /></label>
                                        </div>
                                    </div>
                                    
                             </div>
                              <div class="col-md-4">
									<label><input type="radio" name="rd2" id="geo_url" class="y" value="Geographic URL" <?php if($dataList[0][27]!="") echo "checked";?>> Geo. URL </label>
									<a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" /><strong>1.</strong>Enter the name and area of the organisation in search input box of google map.<br>
                        ...
                        <script type="text/javascript">
							...
							$(".y").click(function() {
								...
								$("#x1").slideUp("normal");
                                  ...
                                  <div class="blockFull">
                                  <input type="hidden" name="lati" id="lati" value="<?php echo $dataList[0][55];?>">
                <input type="hidden" name="longi" id="longi" value="<?php echo $dataList[0][56];?>">
                <input type="hidden" name="prolati" id="prolati" value="<?php echo $dataList[0][57];?>">
                <input type="hidden" name="prolongi" id="prolongi" value="<?php echo $dataList[0][58];?>">
                                  <hr></div>

                     <div class="form-group">
	                    <div class="col-md-1">  <input type="checkbox" id="addContacts" name="addContacts" value="1" <?php if(count($branchDataList)>0) echo "checked";?>>
	                    </div>
	                      <div class="col-md-9"> 
                     ...
                     <div id="branch" <?php if(count($branchDataList)==0){?>style="display:none"<?php } ?>>    
						...
						<div class="form-group">
						    ...
						    <div class="col-md-2">
						    	<select class="form-control" name="txtBranchFocalPersonTitle" id="txtBranchFocalPersonTitle">
                                   ...
                                   <option value="Prof." <?php if($branchDataList[0][5]=="Prof.") echo "selected";?>>Prof.</option>
                               	</select>
						    </div>
						</div>
						...
						<div class="form-group">
						    <label class="control-label col-md-3">&nbsp;</label>
						    <div class="col-md-7">
						    	<input type="text"  name="txtBranchFocalPersonSurname" id="txtBranchFocalPersonSurname" value="<?php echo $branchDataList[0][6];?>" class="form-control" placeholder="Surname"  onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" />
						    </div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-md-3">&nbsp;</label>
						    <div class="col-md-7">
						    	<input type="text"  name="txtBranchFocalPersonName" id="txtBranchFocalPersonName"  value="<?php echo $branchDataList[0][7];?>" class="form-control" placeholder="Name"  onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" />
						    </div>
						</div>
						...
						<div class="form-group">
						    <label class="control-label col-md-3"> <strong>Position</strong> <span class="redmi">*</span> <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />The focal person’s position    </span></a></label>
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtBranchPostion" value="<?php echo $branchDataList[0][8];?>"  id="txtBranchPostion" onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="The focal person’s position">
						    </div>
						</div>
                        ...
                        <div class="form-group">
						    <label class="control-label col-md-3"> <strong>Department</strong> <span class="redmi">*</span> <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />What department is the focal person working in?    </span></a></label>
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtBranchDepartment"  id="txtBranchDepartment" onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="The Department Name"  value="<?php echo $branchDataList[0][9];?>">
						    </div>
						</div>
						...
						<div class="form-group">
						    ...
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtBranchCompanyAddrStreet" id="txtBranchCompanyAddrStreet"  onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="Street, District"  value="<?php echo $branchDataList[0][14];?>">
						    </div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">&nbsp;</label>
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtBranchCompanyAddrCity" id="txtBranchCompanyAddrCity"  onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="City" value="<?php echo $branchDataList[0][12];?>">
						 	</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">&nbsp;</label>
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtBranchPostCode" id="txtBranchPostCode"  onKeyUp="this.value=this.value.replace(/[^0-9+-/?+ ]+/g,'')" placeholder="Postal Code" value="<?php echo $branchDataList[0][13];?>">
						    </div>
						</div>
						...
						<?php 
							...
							for($i=0;$i<count($branchOffcPhn);$i++){ ?>                     
                            <?php
							if($i==0){?>
						<div class="form-group">
						    <label class="control-label col-md-3"> <strong>Office Phone</strong> <span class="redmi">*</span> <a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" />Click “+” to add more     </span></a></label>
						    <div class="col-md-6" id="input_fields_wrapBranch">
						    	<input type="text" class="form-control" name="txtBranchOffcPhone[]" id="txtBranchOffcPhone" onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="Office phone no" value="<?php echo $branchOffcPhn[$i];?>">
						    </div>
						    <div class="col-md-1">
                         ...
                         <?php } } ?>
                         <?php 
							if($branchDataList[0][16]!=""){
							$branchFaxNo = explode(",",$branchDataList[0][16]);
							for($i=0;$i<count($branchFaxNo);$i++){ ?>                     
                            <?php
							if($i==0){?>
                            <div class="form-group">
                                ...
                                <div class="col-md-6" id="input_fields_wrap_faxBranch">
                                    <input type="text" class="form-control" name="txtBranchFax[]" id="txtBranchFax" onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="Fax no." value="<?php echo $branchFaxNo[$i];?>">
                                </div>
                                <div class="col-md-1">
                        ...
                        <?php } } ?>
						<?php 
							if($branchDataList[0][17]!=""){
							$branchMobileNo = explode(",",$branchDataList[0][17]);
							for($i=0;$i<count($branchMobileNo);$i++){ ?>                     
                            <?php
							if($i==0){?>
						<div class="form-group">
						    ...
						    <div class="col-md-6" id="input_fields_wrap_mobileBranch">
						    	<input type="text" class="form-control" name="txtBranchMobilePhone[]" id="txtBranchMobilePhone" onKeyUp="this.value=this.value.replace(/[^a-zA-Z-_&.,0-9/?+ ]+/g,'')" placeholder="The focal person’s mobile no" value="<?php echo $branchMobileNo[$i];?>">
						    </div>
						    <div class="col-md-1">
...
Use comma ‘,’ to add more email addresses    </span></a></label>
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtBranchEmail" id="txtBranchEmail"  placeholder="Email ID" value="<?php echo $branchDataList[0][18];?>">
						    </div>
						</div>
						...
						<div class="form-group">
						    ...
						    <div class="col-md-7">
						    	<input type="text" class="form-control" name="txtBranchCompanyWebsite" id="txtBranchCompanyWebsite" placeholder="Company Website(if any)" value="<?php echo $branchDataList[0][19];?>">
						    </div>
						</div>
						<!--begin social field-->
                         <?php
						      $bEecom = explode(",",$branchDataList[0][20]);
						      $bEcomUrl = explode(",",$branchDataList[0][21]);
							  for($i=0;$i<count($bEecom);$i++){ 
							  if($i==0){ ?>
...
Select your company’s social network / e-commerce platform first and then provide URL or ID in the box beside
							    ...
							    <div class="col-md-2"  id="input_fields_wrap_selBranch">
							    	<select class="form-control" name="selBranchEcommerce[]" id="selBranchEcommerce">
										<option value=" ">Select</option>
										<option value="Twitter" <?php if($bEecom[0][20]=="Twitter") echo "selected";?>>Twitter </option>
										<option value="Facebook" <?php if($bEecom[0][20]=="Facebook") echo "selected";?>>Facebook </option>
										<option value="Line"  <?php if($bEecom[0][20]=="Line") echo "selected";?>>Line </option>
										<option value="LinkedIn"  <?php if($bEecom[0][20]=="LinkedIn") echo "selected";?>>LinkedIn </option>
										<option value="Amazon" <?php if($bEecom[0][20]=="Amazon") echo "selected";?>>Amazon </option>
										<option value="Alibaba"  <?php if($bEecom[0][20]=="Alibaba") echo "selected";?>>Alibaba </option>
										<option value="eBay"   <?php if($bEecom[0][20]=="eBay") echo "selected";?>>eBay</option>
										<option value="Other"  <?php if($bEecom[0][20]=="Other") echo "selected";?>>Other</option>  
	                                </select>
							    </div>

							    <div class="col-md-3"  id="">
							    	<input type="text" class="form-control" name="txtBranchEcomUrl[]" id="txtBranchEcomUrl" placeholder="" value="<?php echo $bEcomUrl[$i];?>">
							    </div>
						...
						<div class="form-group">
                        	<label class="control-label col-md-3"> <strong>Google Map</strong></label>
                            <div class="col-md-4">
                            		<label><input type="radio" name="rd2Branch" id="geo_cord" class="xBranch" value="Coordinates" <?php if($branchDataList[0][22]!="") echo "checked";?>> Geo. coordinates</label>
                            		<a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" /><strong>1.</strong>Enter the name and area of the organisation in search input box of google map.<br>
									...
									<strong>4.</strong>From the pop up menu select the latitude and longitude. </span></a><br>
                                    <div id="x1Branch" <?php if($branchDataList[0][22]==""){?>style="display:none;"<?php } ?> class="form-group">
                                        <div class="col-md-12">
                                            <label>Latitude <input type="text"  name="txtBranchLatitude" id="txtBranchLatitude" class="form-control"   value="<?php echo $branchDataList[0][22];?>"/></label>
                                        </div>  
           
                                        <div class="col-md-12">       
                                        <label>Longitude <input type="text"  name="txtBranchLongitude" id="txtBranchLongitude"   value="<?php echo $branchDataList[0][23];?>" class="form-control" /></label>
                                        </div>
                                    </div>
                                    
                             </div>
                              <div class="col-md-4">
									<label><input type="radio" name="rd2Branch" id="geo_url" class="yBranch" value="Geographic URL" <?php if($branchDataList[0][24]!="") echo "checked";?>> Geo. URL  </label>
									<a class="tooltip" href="javascript:void(0)"><strong>(?)</strong> <span class="custom help"><img src="images/Help.png" id="img" alt="Help" height="48" width="48" /><strong>1.</strong>Enter the name and area of the organisation in search input box of google map.<br>
                       ...
                       <div id="y1Branch" style="display:none;">
                       		<div class="form-group">
	                        	<label class="control-label col-md-3"></label> 
	                        	<div class="col-md-7"> 
                            	<input type="text"  name="txtBranchUrl" id="txtBranchUrl" class="form-control" value="<?php echo $branchDataList[0][24];?>"/>
                            	</div>
                            </div>
                        </div>
                        <script type="text/javascript">
							...
							$(".yBranch").click(function() {
								...
								$("#x1Branch").slideUp("normal");
                                  ...
                                  <div class="blockFull">
                                  <input type="hidden" name="branchlati" id="branchlati" value="<?php echo $dataList[0][25];?>">
                <input type="hidden" name="branchlongi" id="branchlongi" value="<?php echo $dataList[0][26];?>">
                <input type="hidden" name="branchprolati" id="branchprolati" value="<?php echo $dataList[0][27];?>">
                <input type="hidden" name="branchprolongi" id="branchprolongi" value="<?php echo $dataList[0][28];?>">
                                  <hr></div>
                                  <script type="text/javascript">
												(function($) {
