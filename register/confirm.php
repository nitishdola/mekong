...
<section class="sec-padding page-title">
	...
	<div class="thm-container">
        ...
        <div align="center"> Thank You. Your data has been submitted successfully to the Administrator.<br>

        Click here to <a href="<?php echo $webUrl;?>register/">login</a> and view your submitted data.
        <br/>
